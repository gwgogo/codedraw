...
*/ 
	...
	@ResponseBody
	public  Map<?,?> getData(@RequestParam("communityNo") Integer communityNo, Authentication authentication, ModelMap modelMap) throws Exception {
		List<WordTable> data= new ArrayList<WordTable>();
		data = wordCountService.getData(communityNo);
		modelMap.put("kwangwon", data);
		return modelMap;
	}
