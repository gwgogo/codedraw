...
public class BasketController {
	...
	public JSONObject addBasket(HttpServletRequest request, @PathVariable("productID") int productID, @PathVariable("quantity") int quantity) 
			throws AuthException, SQLCustomException, RangeNotSatisfyException, NullCustomException  {
	...
	public List<BasketDto> basket(HttpServletRequest request) throws AuthException{
	...
	private String getUserID(String rawCookie) throws AuthException{
		String session = sessionManger.getSession(rawCookie);
		return sessionManger.getUserId(session);
	}	
}
