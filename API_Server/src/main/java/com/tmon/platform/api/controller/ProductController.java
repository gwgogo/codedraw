...
public class ProductController {
	...
	public ProductDto productByProductId(@PathVariable("product_id")int product_id) throws CustomException {
	...
	public List<OrderProductDto> productByReservationId(@PathVariable("reservation_id") int reservation_id) throws CustomException{
	...
	public List<ProductDto> productByCategoryId(@PathVariable("category_id") int category_id) throws CustomException{
	...
	public JSONObject deleteProduct(@PathVariable("product_id")int product_id) throws SQLException {
